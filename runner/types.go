...
type Result struct {
	...
	ASN              interface{} `json:"asn,omitempty" csv:"asn" dsl:"asn"`
	err              error
	CSPData          *httpx.CSPData    `json:"csp,omitempty" csv:"csp" dsl:"csp"`
	TLSData          *clients.Response `json:"tls,omitempty" csv:"tls" dsl:"tls"`
	...
	ExtractRegex     []string          `json:"extract_regex,omitempty" csv:"extract_regex" dsl:"extract_regex"`
	CDNName          string            `json:"cdn_name,omitempty" csv:"cdn_name" dsl:"cdn_name"`
	...
	Title            string `json:"title,omitempty" csv:"title" dsl:"title"`
	str              string
	Scheme           string              `json:"scheme,omitempty" csv:"scheme" dsl:"scheme"`
	Error            string              `json:"error,omitempty" csv:"error" dsl:"error"`
	...
	FavIconMMH3      string              `json:"favicon,omitempty" csv:"favicon" dsl:"favicon"`
	FinalURL         string              `json:"final_url,omitempty" csv:"final_url" dsl:"final_url"`
	ResponseHeader   map[string]string   `json:"header,omitempty" csv:"header" dsl:"header"`
	RawHeader        string              `json:"raw_header,omitempty" csv:"raw_header" dsl:"raw_header"`
	Request          string              `json:"request,omitempty" csv:"request" dsl:"request"`
	ResponseTime     string              `json:"time,omitempty" csv:"time" dsl:"time"`
	Jarm             string              `json:"jarm,omitempty" csv:"jarm" dsl:"jarm"`
	ChainStatusCodes []int               `json:"chain_status_codes,omitempty" csv:"chain_status_codes" dsl:"chain_status_codes"`
	A                []string            `json:"a,omitempty" csv:"a" dsl:"a"`
	CNAMEs           []string            `json:"cname,omitempty" csv:"cname" dsl:"cname"`
	Technologies     []string            `json:"tech,omitempty" csv:"tech" dsl:"tech"`
	Extracts         map[string][]string `json:"extracts,omitempty" csv:"extracts" dsl:"extracts"`
	Chain            []httpx.ChainItem   `json:"chain,omitempty" csv:"chain" dsl:"chain"`
	...
	VHost            bool                `json:"vhost,omitempty" csv:"vhost" dsl:"vhost"`
	WebSocket        bool                `json:"websocket,omitempty" csv:"websocket" dsl:"websocket"`
	CDN              bool                `json:"cdn,omitempty" csv:"cdn" dsl:"cdn"`
	HTTP2            bool                `json:"http2,omitempty" csv:"http2" dsl:"http2"`
	Pipeline         bool                `json:"pipeline,omitempty" csv:"pipeline" dsl:"pipeline"`
}
